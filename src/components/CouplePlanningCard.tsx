    ...
    <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-xs border border-slate-200 dark:border-slate-800 space-y-6 transition-colors">
      ...
      {!isCouple ? (
        ...
        <div className="space-y-4 animate-fade-in">
          ...
          <div className="bg-gradient-to-r from-indigo-900 via-slate-900 to-indigo-950 text-white rounded-2xl p-4 shadow-sm border border-indigo-800/50 space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-indigo-300 font-bold text-xs">
                <Sparkles className="w-4 h-4 text-amber-300" />
                <span>UK Joint Couple Tax & Retirement Advantages</span>
              </div>
              <span className="text-[10px] bg-indigo-500/20 text-indigo-200 px-2 py-0.5 rounded-full font-semibold border border-indigo-400/30">
                2024/25 Rules
              </span>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-1">
              <div className="bg-white/10 rounded-xl p-3 border border-white/10">
                <p className="text-[10px] text-indigo-200 font-medium">Dual Personal Allowance</p>
                <p className="text-base font-extrabold text-amber-300 mt-0.5">£25,140 <span className="text-xs font-normal text-white/80">/ yr</span></p>
                <p className="text-[10px] text-indigo-100/70 mt-1">Both partners get £12,570 tax-free income allowance in drawdown.</p>
              </div>
              <div className="bg-white/10 rounded-xl p-3 border border-white/10">
                <p className="text-[10px] text-indigo-200 font-medium">Dual Full State Pension</p>
                <p className="text-base font-extrabold text-emerald-300 mt-0.5">£23,082.80 <span className="text-xs font-normal text-white/80">/ yr</span></p>
                <p className="text-[10px] text-indigo-100/70 mt-1">Combined guaranteed inflation-protected income at SP age.</p>
              </div>
              <div className="bg-white/10 rounded-xl p-3 border border-white/10">
                <p className="text-[10px] text-indigo-200 font-medium">Dual ISA & LSA Allowance</p>
                <p className="text-base font-extrabold text-sky-300 mt-0.5">£40,000 <span className="text-xs font-normal text-white/80">ISA / yr</span></p>
                <p className="text-[10px] text-indigo-100/70 mt-1">2x £20,000 annual ISA & 2x £268,275 Lump Sum Allowance limit.</p>
              </div>
            </div>
          </div>
        </div>
