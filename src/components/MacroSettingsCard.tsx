...
export const MacroSettingsCard: React.FC<MacroSettingsCardProps> = ({ profile, onChange }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-3xl p-6 shadow-xs border border-slate-200 dark:border-slate-800 space-y-6 transition-colors">
      ...
      {/* POT-SPECIFIC GROWTH RATE OVERRIDES SECTION */}
      <div className="pt-4 border-t border-slate-100 dark:border-slate-800 space-y-4">
        
        {/* Overrides Toggle Header */}
        ...
        {overrides.enabled && (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 bg-slate-50 dark:bg-slate-800/40 p-4 rounded-2xl border border-slate-200 dark:border-slate-700">
            ...
            <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 space-y-1.5">
              ...
              <input
                ...
                className="w-full px-2.5 py-1 bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs font-bold text-slate-900 dark:text-white"
              />
              <span className="text-[10px] text-slate-400 block">Real: +{((overrides.workplacePensionReturn ?? 7.0) - (inflation) || 0).toFixed(1)}% p.a.</span>
            </div>
            ...
            <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 space-y-1.5">
              ...
              <input
                ...
                className="w-full px-2.5 py-1 bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs font-bold text-slate-900 dark:text-white"
              />
              <span className="text-[10px] text-slate-400 block">Real: +{((overrides.sippReturn ?? 7.5) - (inflation) || 0).toFixed(1)}% p.a.</span>
            </div>
            ...
            <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 space-y-1.5">
              ...
              <input
                ...
                className="w-full px-2.5 py-1 bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs font-bold text-slate-900 dark:text-white"
              />
              <span className="text-[10px] text-slate-400 block">Real: +{((overrides.stocksAndSharesIsaReturn ?? 7.5) - (inflation) || 0).toFixed(1)}% p.a.</span>
            </div>
            ...
            <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 space-y-1.5">
              ...
              <input
                ...
                className="w-full px-2.5 py-1 bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs font-bold text-slate-900 dark:text-white"
              />
              <span className="text-[10px] text-slate-400 block">Real: +{((overrides.cashIsaReturn ?? 4.2) - (inflation) || 0).toFixed(1)}% p.a.</span>
            </div>
            ...
            <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 space-y-1.5">
              ...
              <input
                ...
                className="w-full px-2.5 py-1 bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs font-bold text-slate-900 dark:text-white"
              />
              <span className="text-[10px] text-slate-400 block">Real: +{((overrides.lisaReturn ?? 6.5) - (inflation) || 0).toFixed(1)}% p.a.</span>
            </div>
            ...
            <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 space-y-1.5">
              ...
              <input
                ...
                className="w-full px-2.5 py-1 bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs font-bold text-slate-900 dark:text-white"
              />
              <span className="text-[10px] text-slate-400 block">Real: +{((overrides.giaReturn ?? 6.5) - (inflation) || 0).toFixed(1)}% p.a.</span>
            </div>

            {/* Cash Savings / High-Yield Savings */}
            <div className="p-3 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 space-y-1.5 sm:col-span-2">
              <label className="text-xs font-bold text-slate-800 dark:text-slate-200 flex items-center justify-between">
              ...
              <input
                ...
                className="w-full px-2.5 py-1 bg-slate-50 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-lg text-xs font-bold text-slate-900 dark:text-white"
              />
              <span className="text-[10px] text-slate-400 block">Real: +{((overrides.cashSavingsReturn ?? 3.5) - (inflation) || 0).toFixed(1)}% p.a. (Accurately models cash drag vs inflation)</span>
            </div>
