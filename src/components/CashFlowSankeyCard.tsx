...
export const CashFlowSankeyCard: React.FC<CashFlowSankeyCardProps> = ({
  ...
  const flowData = useMemo(() => {
    ...
    if (!p.isRetired) {
      ...
      const priGiltIncome = (p.giltLadderIncomeReceived || 0) * scale;
      const priGiltCapital = (p.giltLadderCapitalAllocated || 0) * scale;
      ...
      const priLifeEventsInc = (p.lifeEventsIncome || 0) * scale;
