  ...
  it('runs on Plan 55 scenario and returns reasonable results', () => {
    const plan55Profile: any = {
      ...
      assetAllocationSplit: {
        enabled: true,
        accumulation: { equity: 100, bond: 0, cashPercent: 0 },
        decumulation: { equity: 55, bond: 36, cashPercent: 9 },
